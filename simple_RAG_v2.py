...
def convert_to_text(input_file: str, output_file: str) -> Optional[str]:
    ...
    elif file_type.startswith("text/") or file_type == "application/vnd.openxmlformats-officedocument.wordprocessingml.document":
...
def process_documents(file_paths: List[str]) -> Tuple[Any, Any, Any]:
    ...
    for file_path in file_paths:
        ...
        loader = PyMuPDFLoader(temp_text_file)
        data = loader.load()
